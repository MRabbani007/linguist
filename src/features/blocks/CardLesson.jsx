...
export default function CardLesson({ lesson }) {
  ...
  return (
    <div
      onClick={blockOpen}
      className="flex flex-col items-center justify-center min-w-[300px] md:min-w-[400px] min-h-[150px] bg-gradient-to-b from-sky-900 to-sky-600 text-white flex-1 text-center text-xl hover:shadow-lg hover:shadow-zinc-400 cursor-pointer duration-200 relative "
    >
